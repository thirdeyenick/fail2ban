...
import (
	...
	f2bHandler "github.com/thirdeyenick/fail2ban/pkg/fail2ban/handler"
	lAllow "github.com/thirdeyenick/fail2ban/pkg/list/allow"
	lDeny "github.com/thirdeyenick/fail2ban/pkg/list/deny"
	"github.com/thirdeyenick/fail2ban/pkg/response/status"
	"github.com/thirdeyenick/fail2ban/pkg/rules"
	uAllow "github.com/thirdeyenick/fail2ban/pkg/url/allow"
	uDeny "github.com/thirdeyenick/fail2ban/pkg/url/deny"
)
